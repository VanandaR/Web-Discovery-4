        ...
        <div class="uk-grid uk-grid-width-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-2 animate" data-uk-scrollspy="{cls:'uk-animation-slide-bottom animated',target:'> *',delay:300,topoffset:-100}">
            <div class="uk-margin-top">
                ...
                <div class="uk-text-center" style="margin:50px">
                    <a href="#" class="uk-text-center md-btn md-btn-large md-bg-yellow-500">Register Now</a>
                </div>
            </div>
            <div class="uk-margin-top">
        ...
        <ul id="team_tabbed" class="uk-switcher uk-margin">
            <li>
                <div class="uk-grid uk-grid-medium uk-grid-width-small-1-1 uk-grid-width-medium-1-1 uk-grid-width-large-1-1" data-uk-grid-margin>
                    <div>
                        <img src="<?php echo base_url();?>assets/img/landingpage/pendaftaranonline.png">
        ...
        <div class="animate" data-uk-scrollspy="{cls:'uk-animation-slide-right animated',target:'> *',delay:300}">
            <div class="uk-grid">
                <div class="uk-width-large-1-2 uk-container-center uk-text-center">
                    <a href="<?php echo base_url();?>assets/pedoman/Rulebook_Discovery_4.docx" class="uk-text-center md-btn md-btn-large md-btn-primary">Rulebook</a>
                    <a href="<?php echo base_url();?>assets/pedoman/Pedoman_Penulisan_Discovery_4.docx" class="uk-text-center md-btn md-btn-large md-btn-primary">Pedoman Penulisan</a>
                </div>
...
<section class="section" id="sect-kontak">
    <div class="uk-container-center">
        ...
        <div class="uk-grid uk-margin-medium-top uk-margin-large-bottom" style="padding-left: 0px" data-uk-grid-margin>
            <div class="uk-width-small-1-1 uk-width-medium-1-1 uk-width-large-1-1 animate" data-uk-scrollspy="{cls:'uk-animation-slide-left animated',target:'> *',delay:400,topoffset:-100}">
                <div class="uk-margin-top">
                    <img src="<?php echo base_url();?>assets/img/landingpage/contact4.png">
                </div>
            </div>
        </div>
    ...
    <div class="uk-container uk-container-center uk-invisible" data-uk-scrollspy="{cls:'uk-animation-scale-up uk-invisible',delay:300,topoffset:-100}">
        <div class="uk-grid">
            <div class="uk-width-large-3-5 uk-container-center uk-text-center">
                <img src="<?php echo base_url();?>assets/img/landingpage/contact3.png">
            </div>
        </div>
    </div>
</section>
